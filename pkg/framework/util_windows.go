...
var (
	// framework.DefaultPodLabels are labels used by default in pods
	...
	DefaultContainerCommand = []string{"cmd", "/c", "ping -t localhost"}
)

const (
	// DefaultContainerImage is the default image used for containers
	DefaultContainerImage string = "mcr.microsoft.com/windows/servercore:ltsc2019"
)
